// 环境变量配置(必填)
let email = "xejop66974@gddcorp.com";      // SAP登录邮箱,直接填写或设置环境变量，变量名：EMAIL
let password = "wEbM79K6BkOgQSCn4fXZ";   // SAP登录密码,直接填写或设置环境变量，变量名：PASSWORD
...
const MONITORED_APPS = [ // 格式: {url: "应用URL", name: "应用名称"}
  {url: "https://free-sggsmyhx.cfapps.ap21.hana.ondemand.com", name: "free-sggsmyhx"},  
  {url: "https://free-uszbmgvg.cfapps.us10-001.hana.ondemand.com", name: "free-uszbmgvg"}
];
